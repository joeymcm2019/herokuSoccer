...
useEffect( () => {
    ...
    const fetchString = "https://joeysoccerapp.herokuapp.com/" + "getCities/" + state.replace(/\s/g, "_"); //setup fetch
...
const getGroups = () => {
    ...
    var url = new URL("https://joeysoccerapp.herokuapp.com/" + "findGroups/" + state + "/" + city);
...
const joinGroup = (e) => {
    ...
    if (userContext.players.find((name) => name === userContext.username)){
        ...
        setGroupsFound(false);
        var url = new URL("https://joeysoccerapp.herokuapp.com/" + "joinGroup");
        fetch(url, {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json",
...
const updateUserProfile = () => {
    const url = new URL("https://joeysoccerapp.herokuapp.com/" + "updateProfileGroups");
    fetch(url, {
        method: "PATCH",
        // Pass authentication token as bearer token in header
        headers: {
