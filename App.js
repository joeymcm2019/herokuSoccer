...
app.use(cors({
    origin: "https://joeysoccerapp.herokuapp.com/", //react app is hosted here
    credentials: true
}));
...
app.get('/getCities/:state', function (req, res) {
    console.log("attempting fetch");
    const fileString = "./client/locationInfo/data/United_States-US/" + req.params.state + "/allCities.lite.json";
    ...
    try {
        ...
        console.log(error);
        res.json({ success: false, error: error, file: process.cwd()});
    }
});
